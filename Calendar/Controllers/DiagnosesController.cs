...
namespace Calendar.Controllers
{
    public class DiagnosesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,Name,Code")] Diagnosis diagnosis)
        {
            ...
            ViewData["PatientId"] = new SelectList(_context.Set<Patient>(), "Id", "FirstName", diagnosis.PatientId);
            return View(diagnosis);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientId,Name,Code")] Diagnosis diagnosis)
        {
            if (id != diagnosis.Id)
            {
                return NotFound();
